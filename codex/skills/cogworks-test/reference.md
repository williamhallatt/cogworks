...
| Layer 2: LLM-as-judge (5 dimensions) | Implemented (Claude-specific) | `cogworks-test/SKILL.md` |
...
**Codex note**: Layer 1 is fully supported. Layer 2 and behavioral gates require Claude-specific tooling and are not part of the default Codex workflow.
