...
- `skills/cg-distill/` — synthesis methodology: turn one or more sources on a topic into a decision-first knowledge base
- `skills/cg-build/` — skill-authoring doctrine: structure, package, and validate an agent skill for its target runtime

Both work standalone. Install with `npx skills add williamhallatt/cogworks`. See [README.md](README.md).

## Project structure

- `skills/cg-distill/`, `skills/cg-build/` — canonical skill sources; edit here directly
