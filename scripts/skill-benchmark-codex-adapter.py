...
def normalize_events_to_observation(
    *,
    ...
    return {
        ...
        "integrity": {
            "trace_mode": "replay" if replay_mode else "live",
            "raw_event_count": len(events),
            "raw_event_parse_errors": len(raw_errors),
            "observation_complete": return_code == 0 and not raw_errors,
        },
    }
...
def main() -> int:
    ...
    replay_mode = bool(args.replay_events)
