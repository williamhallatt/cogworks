...
2. **Concept Extraction** — Before extracting, reason: "What understanding can I build here that neither source contains alone?" Write one sentence answering this before proceeding. If your answer is "I will list what each source says," stop — that is concatenation, not synthesis.
