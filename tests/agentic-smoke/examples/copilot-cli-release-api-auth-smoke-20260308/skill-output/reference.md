# API Authentication Response Handling — Reference
...
6. **Document authentication vs authorization boundary** [Source 2]: Provide clear operator-facing guidance that explains the difference between authentication failure and authorization failure.
...
| Invalid / malformed token | 401 | WWW-Authenticate |
