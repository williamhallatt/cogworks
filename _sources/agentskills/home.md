...
- **Quickstart** — Create your first Agent Skill and see it in action. See [/skill-creation/quickstart](/skill-creation/quickstart).
- **Specification** — The complete format specification for Agent Skills. See [/specification](/specification).
